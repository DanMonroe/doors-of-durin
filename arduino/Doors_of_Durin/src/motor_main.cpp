...
// int rightCurrentDirection = 0;
// int rightCurrentSpeed = 0;
// int rightOpeningDirection = 0;
// int rightTargetOpenPosition = 0;
...
void setSpeed(int speed, int motorIndex) {
  if (motorIndex == LEFT) {
...
void moveTo(int targetPosition, int motorIndex) {
  if (motorIndex == LEFT) {
...
void stepperRunToPosition(int motorIndex) {
