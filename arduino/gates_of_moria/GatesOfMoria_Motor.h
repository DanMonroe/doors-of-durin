...
class GatesOfMoria_Motor {
  ...
  public:
    GatesOfMoria_Motor(bool debug, AccelStepper stepper, uint8_t closedLimitSwitchPin, uint8_t moveButtonPin, uint8_t directionTogglePin, uint8_t _motorRunningLEDPin);
